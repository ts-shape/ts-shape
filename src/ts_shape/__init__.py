...
_EVENTLOG_NAMES = (
    "BacktestResult", "EventLog", "LabelRule", "LambdaDetector", "REGISTRY",
    "RuleSpec", "TriggerSpec", "UnsafeExpression", "compile_expression",
    "concat", "load_dicts", "load_yaml", "register_adapter",
    "register_lambda_rule", "register_object_type", "run_backtest",
    "to_event_log", "to_flat_df", "to_ocel_tables", "unregister_lambda_rule",
    "validate", "OCEL_ACTIVITY", "OCEL_EID", "OCEL_OID", "OCEL_QUALIFIER",
    "OCEL_TIMESTAMP", "OCEL_TYPE", "TS_DETECTOR", "TS_DURATION_S", "TS_PACK",
    "TS_SEVERITY", "TS_START_TIMESTAMP", "TS_VALUE", "XES_ACTIVITY",
    "XES_CASE", "XES_LIFECYCLE", "XES_RESOURCE", "XES_TIMESTAMP",
)
